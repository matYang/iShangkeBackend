...
public class AliyunMain {
    ...
    //
    // public static String uploadImg(final long id, final File file, final
    // String imgName, final String Bucket) {
    ...
    // }
    //
    // public static String uploadFile(final int id, final File file, final
    // String fileName, final String Bucket) {
