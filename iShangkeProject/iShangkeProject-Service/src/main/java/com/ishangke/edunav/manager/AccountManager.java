...
public interface AccountManager {
	 ...
	 *
	 */ 
	AccountBo exchangeCash(AccountBo accountBo, UserBo userBo);
	 ...
	 *
	 */ 
	List<AccountBo> queryHistory(AccountHistoryBo accountHistoryBo, UserBo userBo, PaginationBo paginationBo);
