...
public class ManagerErrorCode {
    ...
    public static final int BOOKING_CHANGE_STATUS_TO_PAYED_ERROR = 0x0004000A;
    public static final String BOOKING_CHANGE_STATUS_TO_PAYED_ERROR_KEY = "booking_change_status_to_payed_error";
    ...
    public static final int PERMISSION_COURSE_CREATECOURSE = 0x01000032;
    public static final String PERMISSION_COURSE_CREATECOURSE_KEY = "permission_course_createCourse";
    public static final int PERMISSION_COURSE_SUBMITCOURSE = 0x01000033;
    public static final String PERMISSION_COURSE_SUBMITCOURSE_KEY = "permission_course_submitCourse";
    public static final int PERMISSION_COURSE_APPROVECOURSE = 0x01000034;
    public static final String PERMISSION_COURSE_APPROVECOURSE_KEY = "permission_course_approveCourse";
    public static final int PERMISSION_COURSE_REJECTCOURSE = 0x01000035;
    public static final String PERMISSION_COURSE_REJECTCOURSE_KEY = "permission_course_rejectCourse";
    public static final int PERMISSION_COURSE_CANCELCOURSE = 0x01000036;
    public static final String PERMISSION_COURSE_CANCELCOURSE_KEY = "permission_course_cancelCourse";
    public static final int PERMISSION_COURSE_REAUBMITCOURSE = 0x01000037;
    public static final String PERMISSION_COURSE_RESUBMITCOURSE_KEY = "permission_course_resubmitCourse";
    public static final int PERMISSION_COURSE_DELETECOURSE = 0x01000038;
    public static final String PERMISSION_COURSE_DELETECOURSE_KEY = "permission_course_deleteCourse";
    public static final int PERMISSION_COURSE_UPDATECOURSE = 0x01000039;
    public static final String PERMISSION_COURSE_UPDATECOURSE_KEY = "permission_course_updateCourse";
    public static final int PERMISSION_COURSE_COMMENTCOURSE = 0x0100003A;
    public static final String PERMISSION_COURSE_COMMENTCOURSE_KEY = "permission_course_commentCourse";
    public static final int PERMISSION_COURSE_QUERYCOURSEBYPARTNER = 0x0100003B;
    public static final String PERMISSION_COURSE_QUERYCOURSEBYPARTNER_KEY = "permission_course_queryCourseByPartner";
    public static final int PERMISSION_COURSE_QUERYCOURSEBYID = 0x0100003C;
    public static final String PERMISSION_COURSE_QUERYCOURSEBYID_KEY = "permission_course_queryCourseById";
    public static final int PERMISSION_COURSE_CREATECOURSETEMPLATE = 0x0100003D;
    public static final String PERMISSION_COURSE_CREATECOURSETEMPLATE_KEY = "permission_course_createCourseTemplate";
    public static final int PERMISSION_COURSE_SUBMITCOURSETEMPLATE = 0x0100003E;
    public static final String PERMISSION_COURSE_SUBMITCOURSETEMPLATE_KEY = "permission_course_submitCourseTemplate";
    public static final int PERMISSION_COURSE_APPROVECOURSETEMPLATE = 0x0100003F;
    public static final String PERMISSION_COURSE_APPROVECOURSETEMPLATE_KEY = "permission_course_approveCourseTemplate";
    public static final int PERMISSION_COURSE_REJECTCOURSETEMPLATE = 0x01000040;
    public static final String PERMISSION_COURSE_REJECTCOURSETEMPLATE_KEY = "permission_course_rejectCourseTemplate";
    public static final int PERMISSION_COURSE_CANCELCOURSETEMPLATE = 0x01000041;
    public static final String PERMISSION_COURSE_CANCELCOURSETEMPLATE_KEY = "permission_course_cancelCourseTemplate";
    public static final int PERMISSION_COURSE_RESUBMITCOURSETEMPLATE = 0x01000042;
    public static final String PERMISSION_COURSE_RESUBMITCOURSETEMPLATE_KEY = "permission_course_resubmitCourserTemplate";
    public static final int PERMISSION_COURSE_DELETECOURSETEMPLATE = 0x01000043;
    public static final String PERMISSION_COURSE_DELETECOURSETEMPLATE_KEY = "permission_course_deleteCourseTemplate";
    public static final int PERMISSION_COURSE_UPDATECOURSETEMPLATE = 0x01000044;
    public static final String PERMISSION_COURSE_UPDATECOURSETEMPLATE_KEY = "permission_course_updateCourseTemplate";
    public static final int PERMISSION_COURSE_QUERYCOURSETEMPLATE = 0x01000045;
    public static final String PERMISSION_COURSE_QUERYCOURSETEMPLATE_KEY = "permission_course_queryCourseTemplate";
    public static final int PERMISSION_COURSE_QUERYCOURSETEMPLATEBYID = 0x01000046;
    public static final String PERMISSION_COURSE_QUERYCOURSETEMPLATEBYID_KEY = "permission_course_queryCourseTemplateById";
    public static final int PERMISSION_COURSE_CREATECOURSECOMMENT = 0x01000047;
    public static final String PERMISSION_COURSE_CREATECOURSECOMMENT_KEY = "permission_course_createCourseComment";
    public static final int PERMISSION_COURSE_DELETECOURSECOMMENT = 0x01000048;
    public static final String PERMISSION_COURSE_DELETECOURSECOMMENT_KEY = "permission_course_deleteCourseComment";
    public static final int PERMISSION_COURSE_QUERYCOURSECOMMENT = 0x01000049;
    public static final String PERMISSION_COURSE_QUERYCOURSECOMMENT_KEY = "permission_course_queryCourseComment";
    ...
    public static final int PERMISSION_COURSE_QUERYCOMMENTBYCOURSEID = 0x01000061;
    public static final String PERMISSION_COURSE_QUERYCOMMENTBYCOURSEID_KEY = "permission_course_queryCommentByCourseId";
    public static final int PERMISSION_COURSE_DELETECOMMENTBYCOURSEID = 0x01000062;
    public static final String PERMISSION_COURSE_DELETECOMMENTBYCOURSEID_KEY = "permission_course_deleteCommentByCommentId";
    public static final int PERMISSION_COURSE_QUERYCATEGORYKEYWORD = 0x01000063;
    public static final String PERMISSION_COURSE_QUERYCATEGORYKEYWORD_KEY = "permission_course_queryCategoryByKeyword";
    public static final int PERMISSION_COURSE_QUERYCOURSEBYFILTER = 0x01000064;
    public static final String PERMISSION_COURSE_QUERYCOURSEBYFILTER_KEY = "permission_course_queryCourseByFilter";
    public static final int PERMISSION_COURSE_TRANSFORMCOURSESTATUS = 0x01000065;
    public static final String PERMISSION_COURSE_TRANSFORMCOURSESTATUS_KEY = "permission_course_transformCourseStatus";
    public static final int PERMISSION_COURSE_TRANSFORMCOURSETMEPLATESTATUS = 0x01000066;
    ...
    public static final String PERMISSION_BOOKING_QUERYGROUPBUYACTIVITYBYID_KEY = "permission_booking_queryGroupBuyActivityById";
    public static final int PERMISSION_BOOKING_QUERYGROUPBUYBOOKINGBYID = 0x01000076;
    public static final String PERMISSION_BOOKING_QUERYGROUPBUYBOOKINGBYID_KEY = "permission_booking_queryGroupBuyBookingById";
    public static final int PERMISSION_BOOKING_UPDATEGROUPBUYACTIVITY = 0x01000077;
