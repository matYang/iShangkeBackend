...
public interface AddressManager {
	 ...
	 *
	 */
	AddressBo createAddress(AddressBo addressBo, UserBo userBo, PartnerBo partnerBo);
	 ...
	 *
	 */
	AddressBo updateAddress(AddressBo addressBo, UserBo userBo, PartnerBo partnerBo);
	 ...
	 *
	 */
	AddressBo deleteAddress(AddressBo addressBo, UserBo userBo, PartnerBo partnerBo);
