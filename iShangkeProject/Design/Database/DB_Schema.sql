...
-- -----------------------------------------------------
-- Table `EduNav`.`PARTNER_CIRCLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EduNav`.`PARTNER_CIRCLE` (
  `ID` INT NOT NULL,
  `PARTNER_ID` INT NOT NULL,
  `CIRCLE_ID` INT NOT NULL,
  `LAST_MODIFY_TIME` DATETIME NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `FK_CIRCLE_USERCIRCLE_idx` (`CIRCLE_ID` ASC),
  INDEX `FK_PARTNER_USERCIRCLE_idx` (`PARTNER_ID` ASC),
  CONSTRAINT `FK_PARTNER_PARTNERCIRCLE`
    FOREIGN KEY (`PARTNER_ID`)
    REFERENCES `EduNav`.`PARTNER` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CIRCLE_PARTNERCIRCLE`
    FOREIGN KEY (`CIRCLE_ID`)
    REFERENCES `EduNav`.`CIRCLE` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `EduNav`.`WIDTHDRAW`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EduNav`.`WIDTHDRAW` (
  `ID` INT NOT NULL,
  `USER_ID` INT NOT NULL,
  `PAYEE_ID` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `EduNav`.`COURSETEMPLATE_TEACHER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EduNav`.`COURSETEMPLATE_TEACHER` (
  `ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `EduNav`.`CLASSPHOTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EduNav`.`CLASSPHOTO` (
  `ID` INT NOT NULL,
  `PARTNER_ID` INT NOT NULL,
  `IMGURL` VARCHAR(100) NULL,
  `TITLE` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `EduNav`.`COURSE_CLASSPHOTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EduNav`.`COURSE_CLASSPHOTO` (
  `ID` INT NOT NULL,
  `COURSE_ID` INT NOT NULL,
  ...
  CONSTRAINT `FK_CLASSPHOTO_COURSECLASSPHOTO`
    ...
    REFERENCES `EduNav`.`CLASSPHOTO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `EduNav`.`COURSETEMPLATE_CLASSPHOTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EduNav`.`COURSETEMPLATE_CLASSPHOTO` (
  `ID` INT NOT NULL,
  `COURSETEMPLATE_ID` INT NOT NULL,
  `CLASSPHOTO_ID` INT NOT NULL,
  `CREATE_TIME` DATETIME NOT NULL,
