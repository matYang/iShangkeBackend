...
DROP TABLE `COURSE_TEMPLATE_CLASS_PHOTO` ;
DROP TABLE `COURSE_CLASS_PHOTO` ;
DROP TABLE `CLASS_PHOTO` ;
DROP TABLE `COURSE_TEMPLATE_TEACHER` ;
DROP TABLE `MESSAGE` ;
DROP TABLE `ACTIVITY` ;
...
CREATE TABLE IF NOT EXISTS `EduNav`.`PARTNER` (
  ...
  `REFERENCE` VARCHAR(45) NULL,
  `PARTNER_INTRO` VARCHAR(400) NULL,
