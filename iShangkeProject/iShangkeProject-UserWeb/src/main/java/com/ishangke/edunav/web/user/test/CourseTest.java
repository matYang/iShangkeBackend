...
public class CourseTest {
    ...
    public void test8() {
        ...
        vo8.setId(1);
        vo81.setId(1);
        CoursePageViewBo course8 = courseFacade.queryCourseByPartner(CourseConverter.fromModel(vo8),
    ...
    public void test12() {
       ...
       vo.setId(1);
        vo12.setId(1);
        vo121.setId(1);
        CourseTemplatePageViewBo courseTemplate = courseFacade.queryCourseTemplateByPartnerId(CourseTemplateConverter.fromModel(vo),
                PartnerConverter.fromModel(vo121), UserConverter.fromModel(vo12), null, "POST/api/v2/user/login/phone");
        System.out.println(courseTemplate);
