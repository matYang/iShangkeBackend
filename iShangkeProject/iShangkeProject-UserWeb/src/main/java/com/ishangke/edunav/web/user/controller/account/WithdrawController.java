...
public class WithdrawController extends AbstractController {
    ...
    public @ResponseBody
    WithdrawPageViewVo queryWithdraw(WithdrawVo withdrawVo, PaginationVo paginationVo, HttpServletRequest req,
        ...
        try {
            ...
            return (WithdrawPageViewVo) this.handleWebException(c, resp);
        }
        ...
        pageViewBo = accountFacade.queryWithdraw(WithdrawConverter.fromModel(withdrawVo), curUser,
    ...
    public @ResponseBody
    WithdrawVo create(@RequestBody WithdrawVo withdrawVo, HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            return (WithdrawVo) this.handleWebException(c, resp);
        }
        int curId = curUser.getId();
        boolean loggedIn = curId > 0;
        if (!loggedIn) {
    ...
    public @ResponseBody
    WithdrawVo update(@RequestBody WithdrawVo withdrawVo, HttpServletRequest req, HttpServletResponse resp) {
        WithdrawVo responseVo = null;
