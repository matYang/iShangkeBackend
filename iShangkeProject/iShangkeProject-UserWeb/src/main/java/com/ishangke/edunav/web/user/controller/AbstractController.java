...
public class AbstractController {
    ...
    protected final SessionBo getSession(HttpServletRequest req) throws Exception{
    ...
    protected final void openSession(SessionBo sessionBo, boolean remember, HttpServletRequest req, HttpServletResponse resp) throws Exception {
