...
public class PartnerEntity {
    ...
    public void setPartnerDistinction(String partnerDistinction) {
        this.partnerDistinction = partnerDistinction == null ? null : partnerDistinction.trim();
    }
    ...
    public void setTaxRegImgUrl(String taxRegImgUrl) {
        this.taxRegImgUrl = taxRegImgUrl == null ? null : taxRegImgUrl.trim();
    }
    ...
    public void setEduQualificationImgUrl(String eduQualificationImgUrl) {
        this.eduQualificationImgUrl = eduQualificationImgUrl == null ? null : eduQualificationImgUrl.trim();
    }
    ...
    public void setHqLocation(String hqLocation) {
        this.hqLocation = hqLocation == null ? null : hqLocation.trim();
    }
    ...
    public void setHqContact(String hqContact) {
        this.hqContact = hqContact == null ? null : hqContact.trim();
    }
    ...
    public void setHqContactPhone(String hqContactPhone) {
        this.hqContactPhone = hqContactPhone == null ? null : hqContactPhone.trim();
    }
    ...
    public void setHqContactSecopt(String hqContactSecopt) {
        this.hqContactSecopt = hqContactSecopt == null ? null : hqContactSecopt.trim();
    }
    ...
    public void setCourseContact(String courseContact) {
        this.courseContact = courseContact == null ? null : courseContact.trim();
    }
    ...
    public void setCourseContactPhone(String courseContactPhone) {
        this.courseContactPhone = courseContactPhone == null ? null : courseContactPhone.trim();
    }
    ...
    public void setStudentInqueryPhone(String studentInqueryPhone) {
        this.studentInqueryPhone = studentInqueryPhone == null ? null : studentInqueryPhone.trim();
    }
    ...
    public void setRegContact(String regContact) {
        this.regContact = regContact == null ? null : regContact.trim();
    }
    ...
    public void setRegContactPhone(String regContactPhone) {
        this.regContactPhone = regContactPhone == null ? null : regContactPhone.trim();
    }
    ...
    public void setRegContactFax(String regContactFax) {
        this.regContactFax = regContactFax == null ? null : regContactFax.trim();
    }
