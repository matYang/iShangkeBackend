...
public class SpreadEntityExtTest extends BaseTest {
    ...
    public void testQuery() {
        ...
        List<SpreadEntityExt> result = spreadEntityExtMapper.list(
                SpreadQueryEntity, page);
    ...
    public void testQuery2() {
        ...
        List<SpreadEntityExt> result = spreadEntityExtMapper.list(
                SpreadEntityExt, page);
        Assert.assertEquals(3, result.size());
    }

    @Test
    public void testGet() {
        SpreadEntityExt getbyid1 = spreadEntityExtMapper.getById(2);
        SpreadEntityExt getbyid2 = spreadEntityExtMapper.getById(3);
        SpreadEntityExt getbyid3 = spreadEntityExtMapper.getById(4);
    ...
    public void testUpdate() {
        SpreadEntityExt upDate = spreadEntityExtMapper.getById(2);
        upDate.setUrl("harry");
        upDate.setRemark("_test_remark_爱上课");
        upDate.setStatus(100);
        upDate.setCreateTime(time);
        spreadEntityExtMapper.update(upDate);
        upDate = spreadEntityExtMapper.getById(2);
        Assert.assertEquals("harry", upDate.getUrl());
        Assert.assertEquals("_test_remark_爱上课", upDate.getRemark());
        Assert.assertSame(100, upDate.getStatus());
