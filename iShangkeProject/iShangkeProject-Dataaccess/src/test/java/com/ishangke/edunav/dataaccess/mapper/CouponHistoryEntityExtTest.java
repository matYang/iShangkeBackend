...
public class CouponHistoryEntityExtTest {
    ...
    public void testList(){
        ...
        couponHistoryEntityExt.setCreateTimeStart(new Date(System.currentTimeMillis() - 10000));
        couponHistoryEntityExt.setLastModifyTimeStart(new Date(System.currentTimeMillis() - 10000));
