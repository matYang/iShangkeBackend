...
service CourseService {
     ...
     *
     */ 
    common.ResponseBo queryByFilter(1: course.CourseBo courseBo, 2: category.CategoryBo categoryBo, 3: location.LocationBo locationBo, 4: location.CircleBo circleBo,5: common.PaginationBo paginationBo) throws (1: fault.BusinessExceptionBo businessExceptionBo)
