...
service LocationService {
     ...
     *
     */
    list<location.LocationBo> query(1: location.LocationBo locationBo, 2: common.PaginationBo paginationBo, 3: string permissionTag) throws (1: fault.BusinessExceptionBo businessExceptionBo)
}