...
service TeacherService{
     ...
     *
     */
    list<teacher.TeacherBo> query(1: teacher.TeacherBo teacherBo, 2: partner.PartnerBo partnerBo, 3: user.UserBo userBo, 4: common.PaginationBo paginationBo, 5: string permissionTag) throws (1: fault.BusinessExceptionBo businessExceptionBo)
