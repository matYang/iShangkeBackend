...
service ClassPhotoService{
     ...
     *
     */
    common.ResponseBo createClassPhoto(1: classPhoto.ClassPhotoBo classPhotoBo, 2: user.UserBo userBo) throws (1: fault.BusinessExceptionBo businessExceptionBo)
     ...
     *
     */
    common.ResponseBo updateClassPhoto(1: classPhoto.ClassPhotoBo classPhotoBo, 2: user.UserBo userBo) throws (1: fault.BusinessExceptionBo businessExceptionBo)
     ...
     *
     */
    common.ResponseBo deleteClassPhoto(1: classPhoto.ClassPhotoBo classPhotoBo, 2: user.UserBo userBo) throws (1: fault.BusinessExceptionBo businessExceptionBo)
