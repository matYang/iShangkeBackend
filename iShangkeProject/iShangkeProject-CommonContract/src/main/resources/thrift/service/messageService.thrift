...
service MessageService{
     ...
     *
     */
    list<message.MessageBo> query(1: message.MessageBo messageBo, 2: user.UserBo userBo, 3: common.PaginationBo paginationBo, 4: string permissionTag) throws (1: fault.BusinessExceptionBo businessExceptionBo)
