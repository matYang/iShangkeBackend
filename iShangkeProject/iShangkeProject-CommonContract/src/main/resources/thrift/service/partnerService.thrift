...
service PartnerService{
     ...
     *
     */ 
    list<partner.PartnerBo>  query(1: partner.PartnerBo partnerBo, 2: common.PaginationBo paginationBo, 3: user.UserBo userBo, 4: string permissionTag) throws (1: fault.BusinessExceptionBo businessExceptionBo) 
     ...
     *
     */ 
    partner.PartnerBo  queryById(1: partner.PartnerBo partnerBo, 2: user.UserBo userBo, 3: string permissionTag) throws (1: fault.BusinessExceptionBo businessExceptionBo) 
